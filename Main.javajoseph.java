class Main {
  public static void main(String[] args) {
    ...
    System.out.print("GAGOO");
    System.out.print("GAGOO");
    //Difference is println makes the words print out on the next line while print just prints it next to the words, (Hello World!)
    //                                                                                                               (Hello World!)
    //                                                                                                               (GAGOOGAGOO)
    ...
    boolean jaydenasai = true;
    boolean SidBum = true;
    System.out.print(Sid + GOO);
    System.out.print(SidBum);
    System.out.println("My favorite bum is "+ Jayden);
